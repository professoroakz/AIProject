...
public class TwitterSearchPoll {
    public static final String TWD_TAG = "#thewalkingdead";
    ...
    private void searchTWD() {
        try {
            String query = buildQuery(TWD_TAG);
            searchTwitter(query);
        }
        catch (Exception ex) {
    ...
    private void searchTwitter(String searchQuery) throws IOException {
        try {
            ...
            System.err.println("Unable to access Twitter");
        }
    }
